...
namespace Carlsound
{
	namespace Meter
	{
		class MeterControllerViewWin32WpfHost : public IMeterPluginView //, 
				   //Steinberg::CPluginView //Vst::EditorView,
		...
		public:
			...
			//------------------------------------------------------------------------
			// iMeterControllerView
			/**  */
			Steinberg::tresult PLUGIN_API setInputLevelFeedback(Steinberg::Vst::ParamValue newLevel) SMTG_OVERRIDE;

			/**  */
			Steinberg::tresult PLUGIN_API setColorFeedback(Steinberg::Vst::ParamValue newColor) SMTG_OVERRIDE;
