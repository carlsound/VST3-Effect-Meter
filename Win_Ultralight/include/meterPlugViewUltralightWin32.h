...
//
#include "include/Ultralight/Ultralight.h"
#include "include//Ultralight/platform/Platform.h"
//
//
//
namespace Carlsound
{
	namespace Meter
	{
		class MeterPlugViewUltralightWin32 : public Steinberg::CPluginView //Vst::EditorView,
		...
		public:
			...
			//
			MeterPlugViewUltralightWin32();
			MeterPlugViewUltralightWin32(const Steinberg::ViewRect* rect);
			~MeterPlugViewUltralightWin32();
		...
		protected:
			...
			//HWND m_parentWindow;
			//
			//ultralight::Platform& m_platform;
		};
	} // namespace Meter
} // namespace Carlsound